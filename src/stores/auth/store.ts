          ...
          messages: [
            {
              ...
              content: `
                ...
                **Формат ответа:**
                ...
                - Ответ должен быть пригоден для встраивания в HTML (чистый текст, разбитый на абзацы).
                - Не используй ненумерованные списки.
                - Каждый раздел (анализ, сравнение, аномалии, тренд, прогноз, стратегия) должен начинаться с заголовка, выделенного словом в верхнем регистре (например, "АНАЛИЗ ПОТРЕБЛЕНИЯ").
                - Используй заголовки второго уровня ## для разделов.
                - Можешь использовать таблицы, списки, выделение жирным или курсивом для важных данных.
                - Избегай перечисления данных по каждому месяцу отдельно, вместо этого группируй информацию по сезонам или значимым периодам.
                - Описание графика замени на текстовое описание трендов и прогнозов.
                - В каждом разделе анализа явно упоминай как минимум один параметр из дополнительной информации о квартире и семье, чтобы пользователь видел персонализацию.
                - Стратегия должна быть конкретной, учитывать количество жильцов, наличие детей и тип сантехники.
        
                **Контекст:**
                - Нормы потребления: горячая вода ~4 куб.м/чел, холодная вода ~6 куб.м/чел, электричество ~100 кВт·ч/чел в месяц.
                - Ответ должен быть информативным, на русском языке, с акцентом на аналитику и прогнозы.
                - Учитывай российские реалии (праздничные дни, сезонность, климат Красноярска).
